...
const FormContact = ({ addNewContact }) => {
  ...
  return (
    <form onSubmit={addContact} className="border p-3 bg-white">
      ...
      <div className='d-flex flex-column'>
        <label htmlFor="inputDescription" className='d-flex align-items-center fw-bold'>Apellido:</label>
        <input
          type="text"
          id='inputLastName'
          ref={lastNameRef}
      ...
      <div className='d-flex flex-column'>
        <label htmlFor="inputDescription" className='d-flex align-items-center fw-bold'>Email:</label>
        <input
          type="email"
          id='inputEmail'
          ref={emailRef}
